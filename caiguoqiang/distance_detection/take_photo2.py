...
camera.set(cv2.CAP_PROP_FRAME_HEIGHT,720*2)
 
counter = 3
utc = time.time()
folder = "G:/Code/distance_detection/photo/" # 拍照文件目录
...
while True:
    ...
    left_frame = frame[0:720*2, 0:1280]
    right_frame = frame[0:720*2, 1280:1280*2]
