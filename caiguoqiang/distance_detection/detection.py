...
if __name__ == '__main__':
    ...
    string = 're'
    # 读取数据集的图片
    iml = cv2.imread('G:/Code/distance_detection/photo/left_%d.bmp' % i)  # 左图
    imr = cv2.imread('G:/Code/distance_detection/photo/right_%d.bmp' % i) # 右图
    ...
    cv2.imwrite('G:/Code/distance_detection/line%d.png' %(i), line)
    ...
    cv2.imwrite('G:/Code/distance_detection/Parallax%d.png' %(i), disp)
    ...
    # detect_x = 724
    # detect_y = 364
    # detect_dis = ( (points_3d[detect_y, detect_x, 0] ** 2 + points_3d[detect_y, detect_x, 1] ** 2 + points_3d[detect_y, detect_x, 2] **2) ** 0.5) / 1000
    # print('距离左摄像头的相对距离为为 %0.3f m' % detect_dis)
